...
OutputBaseFilename=AutoTest.Net-v1.4.0
Compression=lzma
...
Source: "..\ReleaseBinaries\AutoTest.VSIX.vsix"; DestDir: "{app}"; Flags: ignoreversion;
...
[Run]
Filename:"{reg:HKLM\SOFTWARE\Microsoft\VisualStudio\14.0,InstallDir}VSIXInstaller.exe"; Parameters: /q /a AutoTest.VSIX.vsix;WorkingDir: {app}; StatusMsg: "Installing Visual Studio 2015 extension ..."; Flags: runasoriginaluser runhidden; Check: IfVS2015Installed();
...
[UninstallRun]
Filename:"{reg:HKLM\SOFTWARE\Microsoft\VisualStudio\14.0,InstallDir}VSIXInstaller.exe"; Parameters: /a /q /u:AutoTest.VSIX.CodeFusion.92eaa776-8d9b-4fa4-8b43-40d28ae35583;WorkingDir: {app}; StatusMsg: "Uninstalling Visual Studio 2015 extension..."; Flags: runhidden; Check: IfVS2015Installed();
...
[Code]
Function IfVS2015Installed() : Boolean;
var
  sPath: String;
begin
  sPath := ExpandConstant('{reg:HKLM\SOFTWARE\Microsoft\VisualStudio\14.0,InstallDir}');
